...
const EditEdUIUXDevUrl =
  "/assets/images/vectors/EditEd UI-UX Development Illustration.svg";
    ...
    <>
      ...
      <div className={ServicesStyles.Serv1}>
        ...
        <div className={ServicesStyles.ServImg}>
          <Image src={CloudTopUrl} alt="CloudTop Illustration" layout="fill" />
        </div>
      ...
      <div className={ServicesStyles.Serv2}>
        ...
        <p className={ServicesStyles.ServDesc}>
          Expediuz Provides You With The Next Level Hosting Systems, Available
          For All Kinds Of App & Web Hosting! Deploy A HTML, PHP, Python, Node
          JS Website, A Native Application Or An API!
          <br></br>You Name It!
      ...
      <div className={ServicesStyles.Serv3}>
        <h2 className={ServicesStyles.ServHead}>
          CloudBase - Managed Databases<br></br>On The Cloud!
        </h2>
        <div className={ServicesStyles.ServImg}>
          <Image src={CloudDBUrl} alt="CloudBase Illustration" layout="fill" />
        </div>
        <p className={ServicesStyles.ServDesc}>
          Expediuz Serves You The Next Level Cloud Computer Systems, Which Can
          Be Made Available For Any Purpose And With Any Specifications!
      ...
      <div className={ServicesStyles.Serv4}>
        <h2 className={ServicesStyles.ServHead}>
          Get Professionally Managed DNS!
        </h2>
        <div className={ServicesStyles.ServImg}>
          <Image src={DNSManagementUrl} alt="DNS Illustration" layout="fill" />
        </div>
        <p className={ServicesStyles.ServDesc}>
          Get Rid Of Your Headache To Manage DNS And Domains. We Provide Fully
          Managed DNS
          <br></br>With Cloud Computing, Your Dream Of Tomorrow Won&apos;t Be A
          Dream! It&apos;s Gonna Be A Reality!
        </p>
      ...
      <div className={ServicesStyles.Serv5}>
        ...
        <div className={ServicesStyles.ServImg}>
          <Image
            src={CloudStoreUrl}
            alt="CloudStore Illustration"
            layout="fill"
          />
        </div>
        <p className={ServicesStyles.ServDesc}>
          Get Each And Every Data Of Your Devices Into Our Cloud Storages!
          Absolutely Free Of Cost, But With Unlimited Storage And Unlimited
          Bandwidth. We Offer 3FA Security & Encryption Systems To Keep Your
          Data Safe And Secure! And Of Course, Access From Anywhere, Anytime And
          From Any Device.
        </p>
        <Link href="/services/cloudstore">
          <button className={ServicesStyles.GetIntoItBtn}>
            Check It Out Now!
          </button>
        </Link>
      ...
      <div className={ServicesStyles.Serv7}>
        ...
        <p className={ServicesStyles.ServDesc}>
          Do You Have A Great App Idea ? Make Your Dreams Come True With
          &quot;The Code Chip&quot;! Be It A Web App, A Desktop Or A Mobile One
          - We Develop Cross Platform Apps! And Yes - Innovator Gets A Monthly
          Percentage Of App Revenue Generated As Royalty!
        </p>
        <Link href="/services/frontend-dev">
          <button className={ServicesStyles.GetIntoItBtn}>
            Check It Out Now!
          </button>
        </Link>
      ...
      <div className={ServicesStyles.Serv8}>
        ...
        <div className={ServicesStyles.ServImg}>
          <Image
            ...
            alt="UI/UX Development Illustration"
            layout="fill"
          />
        </div>
        <p className={ServicesStyles.ServDesc}>
          Are You Building An App Or A Website ? Then, You Have To Use The Best
          Simplistic And Elegant UI/UX For Your Project, In Order To Survive in
          today&apos;s market. &quot;EditEd&quot; provides you with all! Choose
          From Our Library Or Order Your Own!
        </p>
        <Link href="/services/ui-ux-dev">
          <button className={ServicesStyles.GetIntoItBtn}>
            Check It Out Now!
          </button>
        </Link>
